...
namespace TransicionDatos
{
    public class Imprimir
    {
        ...
        public void Impresion(PrintDocument p, PrintPageEventArgs e, String Titulo)
        {
            if (p.DefaultPageSettings.Landscape == true)
            {
                ...
                e.Graphics.DrawString(Titulo, new Font("Arial", 26, FontStyle.Regular), Brushes.Black, new Point(60, 20));
            ...
            else
            {
                ...
                e.Graphics.DrawString(Titulo, new Font("Arial", 30, FontStyle.Regular), Brushes.Black, new Point(60, 25));
